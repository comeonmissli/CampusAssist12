...
public class FreshAssistActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fresh_assist); 
		
		//创建按钮对应的id数组
		int[] btnIds=new int[]{R.id.woshi,R.id.xuejie,
				R.id.zhengli,R.id.dida,R.id.jiejiao,R.id.qinlian,R.id.shenghuo,R.id.ruxiao};
	    Button[] btns=new Button[btnIds.length];//创建对应长度的按钮数组
	    myOnClickListener myLisener=new myOnClickListener();
	    for(int i=0;i<btns.length;i++){
	    	btns[i]=(Button) this.findViewById(btnIds[i]);
	    	btns[i].setOnClickListener(myLisener);
	    }
	}
  private class myOnClickListener implements OnClickListener{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.fresh_assist, menu);
		return true;
	}
